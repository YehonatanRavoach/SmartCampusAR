...
using TMPro;
/*
 * BuildingListManager.cs
 * ------------------------------------------------------------------------
 * Manages the display of a list of buildings in a Unity UI ScrollView.
 * Responsibilities:
 *   • Initializes Firebase and fetches building data from the database.
 *   • Instantiates UI elements for each building using a prefab.
 *   • Handles image loading from URLs.
 */
